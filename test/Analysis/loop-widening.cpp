// RUN: %clang_analyze_cc1 -analyzer-checker=core,unix.Malloc,debug.ExprInspection -analyzer-max-loop 4 -analyzer-config cfg-loopexit=true,widen-loops=true -verify -std=c++11 %s
